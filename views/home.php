        ...
        <div class="qu-box-left col-9 col-xl-9">
            <div class="qu-post">
                <div class="qu-post-head bg-light">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <a href="/infor?id=<?= $user_id ?>" class="d-flex">
                        ...
                        <?php if(!empty($posts)): ?>
                            ...
                            <div class="post-item my-4">
                                <div class="post-item__head d-flex justify-content-between align-items-center">
                                    <a href="/info?id=<?= $post['id_user'] ?>" class="post-item__head-info d-flex align-items-center">
                                    ...
                                    <div class="comment-list comment-list p-2 d-none bg-light">
                                        ...
                                        <div class="comment-item ">
                                            <div class="d-flex align-items-center my-2">
                                                <a href="/infor?id=<?= $comment['id_user'] ?>" class="d-flex text-decoration-none align-items-center">
                                                    <div class="head-info__img col-2">
            ...
            <div class="qu-post">
                ...
                <div class="qu-top10-post">
                    <div class="list-group list-group-flush">
                        ...
                        <a href="/infor?id=<?= $user_id ?>" class="top-star-item d-flex align-items-center p-2">
                            <div class="" style="width: 50px; height: 50px; border-radius: 50%; overflow: hidden">
